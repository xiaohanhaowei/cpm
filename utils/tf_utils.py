...
def read_batch_cpm(tfr_path, img_size, hmap_size, num_joints, center_radius, batch_size=16, num_epochs=None):
    ...
    with tf.name_scope('Batch_Inputs'):
        ...
        batch_images, batch_centers, batch_labels, batch_images_orig = tf.train.shuffle_batch_join(data_list, batch_size=batch_size, capacity=100 + 6 * batch_size, min_after_dequeue=100,
          enqueue_many=True, name='batch_data_read')
