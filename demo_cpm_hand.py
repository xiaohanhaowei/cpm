#!/home/wanghongwei/anaconda3/envs/tf110/bin/python
...
if sys.version_info.major == 3:
    ...
    PYTHON_VERSION = 2
pre_tr_model_path = '/home/wanghongwei/WorkSpace/detect/cpm-tf/models/weights/cpm_hand/input_256_output_32/joints_6/stages_3/init_0.001_rate_0.5_step_10000'


def main(argv):
    global pre_tr_model_path
    tf_device = '/gpu:0'
    ...
    if FLAGS.model_path.endswith('pkl'):
        ...
        print('*' * 20, FLAGS.model_path, ckpt)  # , os.system('ls %s') % pre_tr_model_path)
        # import pdb
        # pdb.set_trace()
